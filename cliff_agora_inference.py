...
from utils.cliff_image_based_model_inference import cliff_inference_image_based_model
...
def multi_person_with_mmtracking(args, frames_iter):
    ...
    for i, result in enumerate(mmcv.track_iter_progress(result_list)):
        ...
        elif mesh_model.cfg.model.type == 'CliffImageBodyModelEstimator':
            mesh_results = cliff_inference_image_based_model(
                mesh_model,
                frames_iter[frame_id],
                result,
                bbox_thr=args.bbox_thr,
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--mesh_reg_config',
        type=str,
        default=proj_dir+'configs/mmhuman3d/cliff_resnet50_pw3d_cache.py',
        help='Config file for mesh regression')
    parser.add_argument(
        '--mesh_reg_checkpoint',
        type=str,
        default='data/pretrained/pretrain_cliff.pth',
    ...
    parser.add_argument('--tracking_config', 
                        default='demo/mmtracking_cfg/deepsort_faster-rcnn_fpn_4e_mot17-private-half.py',
